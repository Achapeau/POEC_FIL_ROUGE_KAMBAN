...
public class CreateData {
    ...
    public void initData(ApplicationContext context) {
        ...
        UserP u1 = new UserP("JeanValJean@gmail.com", "$2a$10$kfitBkbrOnmtDEoiYthDxOtdZ4LU/oAM9ZZe3Ul3bERcPkHtT8ZTO", "Jean", "ValJean", new ArrayList<Project>(),"");
        UserP u2 = new UserP("BillyBob@gmail.com", "$2a$10$PGv61eS8L6US3nChav/YjOWuuQEZvBWb2j6aWulwDzd1oVAoCKzVq", "Billy", "Bob", new ArrayList<Project>(),"");
        UserP u3 = new UserP("BobbyLarnak@gmail.com", "$2a$10$9A0Zevq15btphGS4MYcX0uwuUD/uLw2B5YPSiQKBeFlQiRXyKqihG", "Bobby", "larnak", new ArrayList<Project>(), "");
        UserP u4 = new UserP("JohnnyLembrouille@gmail.com", "$2a$10$vjmZ/ljcSG.6gz/u4FXdNOC3nujhhCataT8g1Dzr/hV8svSUQtUSW", "Johnny", "lembrouille", new ArrayList<Project>(), "");
        UserP u5 = new UserP("admin@mail.com", "$2a$10$HAutSR2yVEP9ZrMINr9hQu/ky2JwbL2/gDplfh5P6MmrxukLWdh2O", "admin", "admin", new ArrayList<Project>(), "");
        ...
        TaskCard t1 = new TaskCard("Ajouter une fonction create()", "la fonction create() n'existe pas", 0, w1.getId(), TaskStatus.TODO.getStatus());
        w1.addCard(t1);
        taskCardRepository.save(t1);
        TaskCard t2 = new TaskCard("login", "Faire un syteme de login", 1, w2.getId(), TaskStatus.TODO.getStatus());
        w2.addCard(t2);
        taskCardRepository.save(t2);
        TaskCard t3 = new TaskCard("update", "Faire une fonction update", 2, w3.getId(), TaskStatus.TODO.getStatus());
        w3.addCard(t3);
        taskCardRepository.save(t3);
        TaskCard t4 = new TaskCard("delete", "Faire une fonction delete", 3, w4.getId(), TaskStatus.TODO.getStatus());
        w4.addCard(t4);
        taskCardRepository.save(t4);
        TaskCard t5 = new TaskCard("add", "Faire une fonction add", 3, w5.getId(), TaskStatus.IN_PROGRESS.getStatus());
        w5.addCard(t5);
        taskCardRepository.save(t5);
        TaskCard t6 = new TaskCard("read", "Faire une fonction read", 4, w6.getId(), TaskStatus.IN_PROGRESS.getStatus());
        w6.addCard(t6);
        ...
        TaskCard t10 = new TaskCard("delete", "Faire une fonction delete", 2, w3.getId(), TaskStatus.TODO.getStatus());
        w3.addCard(t10);
        taskCardRepository.save(t10);
        TaskCard t11 = new TaskCard("update", "Faire une fonction update", 3, w4.getId(), TaskStatus.IN_PROGRESS.getStatus());
        w4.addCard(t11);
        taskCardRepository.save(t11);
        TaskCard t12 = new TaskCard("delete", "Faire une fonction delete", 3, w5.getId(), TaskStatus.IN_PROGRESS.getStatus());
        w5.addCard(t12);
        taskCardRepository.save(t12);
        TaskCard t13 = new TaskCard("read", "Faire une fonction read", 4, w6.getId(), TaskStatus.IN_PROGRESS.getStatus());
        w6.addCard(t13);
        taskCardRepository.save(t13);
        TaskCard t14 = new TaskCard("update", "Faire une fonction update", 5, w7.getId(), TaskStatus.DONE.getStatus());
        w7.addCard(t14);
